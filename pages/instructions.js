    ...
    return (
        <>
            ...
            <div className={styles.container}>
                ...
                <p><strong>Start with a template:</strong> Clicking on the 'Templates' button, brings up a window that will allow you to peruse a couple dozen templates that you can start with and modify the instrumentation of.</p>
                <p><strong>Generate a new list of instruments: </strong> Generating a new list will replace your current instrumentation with an entirely new list. It asks for a range, but if you want a specific size, you can just put the same number in both fields.</p>
                <p><strong>Add a random group of new instruments: </strong>Adding a new group of instruments will generate as many random instruments as you ask for and add them to your list!</p>
                <p><strong>Choose an instrument to add to the list: </strong> Choose one specific instrument to add to your instrumentation list.</p>
                <p><strong>No Duplicates: </strong>If you dont want multiple of each instrumnet to be able to be generated, check 'No Duplicates' and it will make sure every instrument that is generated for your list is not a duplicate. This does not retroactively apply to instruments already in your list.</p>
                <p><strong>Clear List: </strong>Clicking 'Clear List' will remove all instruments from your list, starting you over fresh</p>
                <h5 style={{textDecoration: 'underline'}}>Instrument Cards</h5>
                <p><strong>Lock: </strong>Locking your instrument prevents it from being deleted in all fashions.</p>
                <p><strong>Shuffle: </strong>The shuffle button will replace just that instrument with a random instrument.</p>
                <p><strong>Delete: </strong>The delete button removes your instruments from the list.</p>
                <p><strong>Replace: </strong>The replace button allows you to pick an instrument to replace it with.</p>
            </div>
